...
void main(){
  ...
  float m = moon(st, 0.132, vec2(0.5, 0.5));

  //float c = circle(st, 0.404, vec2(0.5,0.5), 99999.0)/circle(st, 0.6, vec2(0.390,0.5), 99999.0);
  ...
  color = mix(color, vec3(0.000,0.005,0.001),m);
